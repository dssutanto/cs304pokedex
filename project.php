...
<body>
  <div id="wrapper">
    ...
    <div class="right">
      ...
      if (
        isset($_POST['reset']) || isset($_POST['updateSubmit']) || isset($_POST['insertSubmit']) || isset($_POST['releaseSubmit']) || isset($_POST['searchSubmit']) || isset($_POST['searchIDSubmit']) || isset($_POST['checkWeakSubmit']) ||
        isset($_POST['showSubmit']) || isset($_POST['sortPokemon']) || isset($_POST['groupPokemon']) || isset($_POST['showPokemonNotWeakAgainstSubmit'])
      ) {
        handlePOSTRequest();
      } else if (isset($_GET['countTupleRequest']) || isset($_GET['showTupleRequest']) || isset($_GET['displayPokemonRequest']) || isset($_GET['statPokemonRequest']) || isset($_GET['displayEvolutionsRequest']) || isset($_GET['displayMegaEvolutionsRequest']) || isset($_GET['aggrPokemonRequest'])) {
        handleGETRequest();
      } else if (
