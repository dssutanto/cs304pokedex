    ...
    <body>
      ...
      <div id="wrapper">
        ...
        <select id="sortBy" name="sortBy">
          <option id="ID" value="ID">Species ID</option>
          <option id="Nickname" value="Nickname">Nickname</option>
          <option id="TimeCaught" value="TimeCaught">Day caught</option>
        ...
        <select id="groupBy" name="groupBy">
          <option id="ID" value="ID">Species</option>
          <option id="TimeCaught" value="TimeCaught">Days caught</option>
       ...
       function showStats() {
        ...
        function sortPokemonBy()
        {
          ...
          if (isset($_POST['sortBy']) && isset($_POST['order'])) {
              $sort = $_POST['sortBy'];
              $order = $_POST['order'];
                $res = executePlainSQL("SELECT Pokemon.*, P_Stats.* FROM Pokemon LEFT JOIN P_Stats ON Pokemon.ID = P_Stats.$sort ORDER BY Pokemon.ID $order");
        ...
        function groupPokemonBy(){
          ...
          if (isset($_POST['groupBy']) && isset($_POST['having'])) {
              $group = $_POST['groupBy'];
              $having = $_POST['having'];
                $res = executePlainSQL("SELECT $group, COUNT(*) FROM Pokemon GROUP BY $group HAVING COUNT(*) >= $having");
